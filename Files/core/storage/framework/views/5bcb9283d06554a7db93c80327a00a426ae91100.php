...
<head>
	...
	body {
	  background: url(<?php echo e(asset('assets/admin_bg.jpg')); ?>);
 ...
 <div class="login-page">
  ...
  <div class="form">
    ...
    <?php echo e(csrf_field()); ?>
       ...
       <input type="text" id="#{label}" name="name" value="<?php echo e(old('name')); ?>" required="required" placeholder="username" />
